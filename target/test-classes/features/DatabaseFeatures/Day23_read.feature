...
@db_customer_address
 ...
 @db_customer_email
  ...
  @db_user_email
  Scenario: TC04_read_customer_information_email
    Given user connects to the database
  ...
  @db_user_login
  Scenario: TC05_read_customer_information_login
    Given user connects to the database
    And user gets the "*" from "jhi_user" table
    # Select * from tp_customer; Select all column from tp_customer table
  ...
  @db_user_email1
  Scenario: TC06_read_customer_information_email
    Given user connects to the database
    And user gets the "*" from "jhi_user" table
    ...
    #Test  if user list has foreachloop2020@gmail.com as a valid email
  @db_account_type
  Scenario: TC07 _read_account_information_type
    Given user connects to the database
